...
namespace Game
{
	...
	//	InitProjMatrix(mAngle, static_cast(new_width), static_cast(new_height), mNearest, mFarthest);
	//	InitOrthoMatrix(static_cast(new_width), static_cast(new_height), 0.0f, mFarthest);
	//}
}